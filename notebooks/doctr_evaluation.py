...
from src.models.doctr import load_model, process_image, load_prompt_template, validate_results
...
# Load configuration
try:
    config = load_yaml_config('config/doctr.yaml')
except FileNotFoundError:
    logger.error("Doctr configuration file not found")
    raise
