...
from src.models.pixtral import load_model, process_image, load_prompt_template, validate_results
...
# Load configuration
try:
    config = load_yaml_config('config/pixtral.yaml')
except FileNotFoundError:
    logger.error("Pixtral configuration file not found")
    raise
